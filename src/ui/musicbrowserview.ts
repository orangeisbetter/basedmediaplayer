...
export class MusicBrowserView {
    ...
    private static browserModeComponent: HTMLElement;
    ...
    static init(element: HTMLDivElement) {
        ...
        this.browserModeComponent = document.querySelector("header #main_view_select")!;
        this.browserModeSelector = this.browserModeComponent.querySelector("select, :scope:where(select)")!;
    ...
    static show() {
        ...
        this.browserModeComponent.style.display = "";
    }

    static hide() {
        this.rootElement.style.display = "none";
        this.browserModeComponent.style.display = "none";
    }
    ...
    private static getTrackElement(album: Album, track: Track): DocumentFragment {
        ...
        cells[3].title = cells[3].textContent = track.title ?? "Unknown Title";
